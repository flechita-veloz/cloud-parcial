...
{ /* Interface for SaveSaleModal component props */ }
...
{ /* SaveSaleModal Component: Handles the display and actions for sale completion */ }
const SaveSaleModal: React.FC<SaleModalProps> = ({ isOpen, onClose, sale, billing, billingStatus}) => {
  ...
  const handleSendEmail = async () => {
    ...
    try {
      const response = await fetch("http://localhost:8000/users/enviar-correo", {
        method: "POST",
  ...
  const handleSendWhatsApp = async () => {
    ...
    try {
      const response = await fetch("http://localhost:8000/whatsapp/send", {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          phoneNumber: "51" + whatsappNumber,
          url: `https://back.apisunat.com/documents/${localBilling?.idSunat}/getPDF/A4/${localBilling?.fileNameSunat}.pdf`,
